...
def predict():
    try:
        ...
        if result[0] == 0:
            prediction_text = "CUSTOMERS WITH MEDIUM ANNUAL INCOME AND MEDIUM ANNUAL SPEND (CLUSTER 0)"
        elif result[0] == 1:
            prediction_text = "CUSTOMERS WITH HIGH ANNUAL INCOME BUT LOW ANNUAL SPEND (CLUSTER 1)"
        elif result[0] == 2:
            prediction_text = "CUSTOMERS WITH LOW ANNUAL INCOME BUT HIGH ANNUAL SPEND (CLUSTER 2)"
        elif result[0] == 3:
            prediction_text = "CUSTOMERS WITH HIGH ANNUAL INCOME AND HIGH ANNUAL SPEND (CLUSTER 3)"
